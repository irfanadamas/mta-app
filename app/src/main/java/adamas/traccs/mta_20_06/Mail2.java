...
public class Mail2 extends javax.mail.Authenticator {
    ...
    public Mail2(String host, String Port, String user, String pass,String from,String Subject, String body ) {
        _host = host; // default smtp server
        _port = Port; // default smtp port
        _sport = Port; // default socketfactory port
