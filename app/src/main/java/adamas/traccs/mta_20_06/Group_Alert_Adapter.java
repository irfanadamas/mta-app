...
public class Group_Alert_Adapter extends BaseAdapter 
{
	private final Context context;
	private final  ArrayList<GroupAlerts> values;
    private GroupAlerts grp=null;   
         
	public Group_Alert_Adapter(Context context,  ArrayList<GroupAlerts> values) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            gridView = inflater.inflate(R.layout.group_alert_row, null);
        }else{
